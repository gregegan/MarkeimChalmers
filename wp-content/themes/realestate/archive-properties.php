...
<td style="width:100px;text-align:center;padding-top: 10px; ">Brokers</td>
 ...
 <tr class="action" >
   	...
   	<td class="bnt2">
	   	...
	   	<?php
if(($custom['property_sale_type_sale'][0] == "true" && $custom['property_sale_price'][0] != "0.00" && $custom['property_sale_price'][0] != "") || ($custom['property_sale_type_lease'][0] == "true" && $custom['property_lease_price'][0] != "0.00" && $custom['property_lease_price'][0] != "")) {
